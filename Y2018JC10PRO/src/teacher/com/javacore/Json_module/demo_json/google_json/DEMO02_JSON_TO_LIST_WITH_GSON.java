package teacher.com.javacore.Json_module.google_json;
...
public class DEMO02_JSON_TO_LIST_WITH_GSON {
	...
	public static void main(String[] args) {
		...
		URL url = objcls.getResource("NGUYENVANA/JSONDEMO/GSON/");
		...
		try {
			...
			/*
			 * Type listType = new TypeToken<List<Students>>() { }.getType(); List<Students>
			 * objList = objG.fromJson(objBR, listType);
			 */
