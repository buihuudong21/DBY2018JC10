package teacher.com.javacore.Json_module.google_json.EXAMPLE02;
...
public class SAMPLE02 {
	...
	public static void main(String[] args) {
		...
		if (returnVal == JFileChooser.APPROVE_OPTION) {
			...
			try {
				BufferedReader objBR = new BufferedReader(new FileReader(FileName));
				...
				// C2:
				List<Students> lisStudent = objG.fromJson(objBR, new TypeToken<List<Students>>() {
				}.getType());
