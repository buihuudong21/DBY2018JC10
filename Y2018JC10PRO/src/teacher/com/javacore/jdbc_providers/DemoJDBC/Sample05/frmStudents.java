package com.teacher.jdbc_providers.DemoJDBC.Sample05;
	...
	public frmStudents() {
		...
		btnThucThi.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					objConnection = objData.SQLOpenConnection("127.0.0.1", "sa", "dd", "DEMOBANKING", 1433);
					if (!objConnection.isClosed()) {
						...
						short shOpt = (short) JOptionPane.showConfirmDialog(null,
								"Bạn có chắc chắn muốn xem dữ liệu ko?", "Thông báo", JOptionPane.YES_NO_OPTION);
						...
						if (shOpt == 0) {
							...
							while (objRs.next()) {
								...
								objStudent.setsFullName(objRs.getString("FullName"));
								objStudent.setsEmail(objRs.getString("Email"));
								objStudent.setsMark(objRs.getString("Mark"));
		...
		btnLayThongTin.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				StudentEntity objStudent = (StudentEntity) cboStudent.getSelectedItem();
