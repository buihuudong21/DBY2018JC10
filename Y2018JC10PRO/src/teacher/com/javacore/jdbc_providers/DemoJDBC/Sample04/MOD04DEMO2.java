package Teacher.Y2017JC79.jdbc_providers.DemoJDBC.Sample04;
...
public class MOD04DEMO2 {
	public static void main(String[] args) {
		...
		try {
			objConnection = objData.OpenConnection("127.0.0.1", "nothing", "sa", "TICKETBOX_DB", 1433);
			if (!objConnection.isClosed()) {
				...
				objCmst = objConnection.prepareCall("{call SP_UPDATE_STUDENT(?,?,?,?,?)}");
				...
				if (shOpt == 0) {
					...
					if (objRs != null) {
						while (objRs.next()) {
							...
							System.out.println("- FullName: " + objRs.getString("FullName"));
							System.out.println("- Email: " + objRs.getString("Email"));
							System.out.println("- Mobile: " + objRs.getString("Mobile"));
							System.out.println("- Mark: " + objRs.getFloat("Mark"));
						}
					}
				} else {
